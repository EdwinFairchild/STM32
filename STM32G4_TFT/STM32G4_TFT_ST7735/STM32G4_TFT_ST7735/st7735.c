...
#include "st7735.h"
#include "stdlib.h"
/*******Modifications to port non HAL version*****/
/*  Replace any instance of HAL_SPI_TRANSMIT with 
 *  your own spi transmit and replace all
 *  all instances of HAL_delay with your own     
 *  modify the st7735_cfg.h file given your post and pins used*/
#include "stm32g4xx.h"
